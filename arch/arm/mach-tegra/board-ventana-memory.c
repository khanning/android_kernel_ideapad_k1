...
//++ Charles
        ...
        switch(strap){
                case 0:
                        ...
                        tegra_init_emc(ventana_elpida_emc_chips,
                                ARRAY_SIZE(ventana_elpida_emc_chips));
                        break;
                case 1:
                        pr_info("%s: Hynix 1GB memory found\n", __func__);
                        tegra_init_emc(ventana_hynix_emc_chips,
                                ARRAY_SIZE(ventana_hynix_emc_chips));
                        break;
                default:
                        pr_info("%s: Load Elpida 1GB memory\n", __func__);
                        tegra_init_emc(ventana_elpida_emc_chips,
                                 ARRAY_SIZE(ventana_elpida_emc_chips));
                        break;
        }
