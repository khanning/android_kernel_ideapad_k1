#ifndef YUV2031_SENSOR_TAB_H
#define YUV2031_SENSOR_TAB_H
...
{0x098C, 0x2212},	// MCU_ADDRESS [AE_MAX_DGAIN_AE1]
{0x0990, 0x0080},	// MCU_DATA_0
{0x098C, 0xA20C},	// MCU_ADDRESS [AE_MAX_INDEX]  //Max integration time
/* Compal K1-Carl : frame rate ++ */
//{0x0990, 0x0010},	// 60hZ
{0x0990, 0x0004},
/* Compal K1-Carl -- */
...
enum {
	...
	SENSOR_MODE_1280x960,   //Compal K1 - Carl for CTS
...
static struct sensor_reg *mode_table[] = {
	...
	[SENSOR_MODE_1280x960]  = mode_1280x960,   //Compal K1 - Carl for CTS
